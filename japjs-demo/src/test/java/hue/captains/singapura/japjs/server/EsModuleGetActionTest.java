...
import hue.captains.singapura.japjs.demo.css.PlaygroundStyles;
...
class EsModuleGetActionTest {
    ...
    void execute_autoInjectsCssManagerForDomModuleWithCss() throws Exception {
        ...
        assertTrue(js.contains("import { CssClassManagerInstance as css } from \"/module?class=hue.captains.singapura.japjs.server.CssClassManager\""),
    ...
    void execute_turtleDemoImportsFromThreeJsWrapper() throws Exception {
        ...
        assertTrue(js.contains("from \"/module?class=hue.captains.singapura.japjs.demo.es.ThreeJs\""),
    ...
    void execute_generatedImportsUseQueryParamPaths() throws Exception {
        ...
        var query = new ModuleQuery("hue.captains.singapura.japjs.demo.es.BobModule");
        var result = action.execute(query, new EmptyParam.NoHeaders()).get();
