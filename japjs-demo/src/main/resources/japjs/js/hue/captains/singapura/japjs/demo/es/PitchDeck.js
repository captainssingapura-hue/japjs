// =============================================================================
// japjs — Executive Pitch Deck
//
// A semi-interactive presentation rendered by japjs itself.
...
function appMain(rootElement) {
    ...
    function slideTitle() {
        return ''
            ...
            + '  <h1 class="' + cn(pd_hero_title) + '">japjs</h1>'
    ...
    function slideProposition() {
        return ''
            ...
            + '  Declare the web app\'s module graph, CSS bindings, assets, and inter-tier messages in <span class="' + cn(pd_accent) + '">Java</span>. japjs generates plain ES modules and serves them through whatever HTTP server your team <span class="' + cn(pd_accent) + '">already runs</span>.'
            + '</p>'
    ...
    function slideCompetitive() {
        ...
        var rows = [
            ...
            ["japjs",            "Light",              "Light (stateless)",  "Yes, end-to-end", "Any (adapter)",     "Yes, first-class"]
        ];
    ...
    function slideBuiltDesigned() {
        var built = [
            "japjs-core — module, CSS, SVG, external-module primitives",
            "japjs-server — Vert.x adapter, live reload via japjs.devRoot",
            ...
            "japjs-conformance — CSS raw-op scanner tests",
            "This deck (running on japjs itself)"
        ];
        var designed = [
    ...
    function slideWorkloads() {
        ...
        var wrong = [
            ...
            ["Reactive 3D scene graphs (JSX-for-meshes)",  "japjs hosts Three.js but doesn't abstract it"],
        ...
        return ''
            ...
            + '<h1 class="' + cn(pd_title) + '">Where japjs is — and isn\'t — the right choice.</h1>'
    ...
    function slideAsk() {
        return ''
            ...
            + '    <div class="' + cn(pd_card_body) + '" style="margin-top:8px;font-size:14px;">Adopt japjs for the class of internal tools where the Node-toolchain tax is highest. Consolidate delivery. Give Java engineers a first-class UI path.</div>'
            + '  </div>'
            + '  <div class="' + cn(pd_card_dark) + '" style="border-color:#F4B942;">'
            + '    <div class="' + cn(pd_kicker) + '">Worst case</div>'
            + '    <div class="' + cn(pd_card_body) + '" style="margin-top:8px;font-size:14px;">Ship one useful internal tool, collect data on your own pipeline, decide japjs is not for you. One team-month. Backend work is reusable.</div>'
            + '  </div>'
            + '</div>'
            + '<p class="' + cn(pd_quote) + '" style="margin-top:32px;">If your Java teams are building long-lived internal web tools and the Node toolchain feels like a tax — japjs is worth 4 weeks to find out.</p>'
