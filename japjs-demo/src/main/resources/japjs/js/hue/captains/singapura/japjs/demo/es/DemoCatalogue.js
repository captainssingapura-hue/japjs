// =============================================================================
// japjs demo catalogue (RFC 0001 Step 11 — migrated to typed nav + href)
...
function appMain(rootElement) {
    ...
    html += '<div class="' + cn(cat_header) + '">'
          ...
          + '  <p class="' + cn(cat_subtitle) + '">Every demo is a working japjs <span class="' + cn(cat_mono) + '">AppModule</span>. Click any card to open. The simple-name shown on each card is the public URL identifier — paste it into a <span class="' + cn(cat_mono) + '">/app?app=…</span> URL elsewhere.</p>'
          + '</div>';
    ...
    html += '<div class="' + cn(cat_footer) + '">'
          + '  All demos are AppModules under <code>hue.captains.singapura.japjs.demo.es</code>. '
