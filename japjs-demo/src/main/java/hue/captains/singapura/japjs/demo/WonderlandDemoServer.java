...
import hue.captains.singapura.japjs.demo.es.DancingAnimals;
...
import hue.captains.singapura.japjs.demo.es.MovingAnimal;
import hue.captains.singapura.japjs.demo.es.PitchDeck;
import hue.captains.singapura.japjs.demo.es.SpinningAnimals;
...
public class WonderlandDemoServer {
    ...
    public static void main(String[] args) {
        ...
        var registry = new JapjsActionRegistry(nameResolver, appResolver);
