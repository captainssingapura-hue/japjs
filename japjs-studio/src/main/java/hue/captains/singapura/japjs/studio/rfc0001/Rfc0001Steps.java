...
public final class Rfc0001Steps {
    ...
    public static final List<Step> STEPS = List.of(
            ...
            new Step("07",
                    "Server — `?app=` Dispatch",
                    "JapjsActionRegistry adds `?app=` URL contract and routes via SimpleAppResolver. `?class=` retained for the Step 11 migration window.",
                    ...
                    List.of(
                            ...
                            new Task("`JapjsActionRegistry` accepts optional `SimpleAppResolver` (3 constructor overloads for backwards compat)", true),
